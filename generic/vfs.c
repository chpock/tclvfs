...
#define Tcl_SaveResult(i, r) Tcl_IncrRefCount((*(r) = Tcl_GetObjResult(i)))
#define Tcl_RestoreResult(i, r) do {Tcl_SetObjResult(i, *(r)); Tcl_DecrRefCount(*(r));} while (0)
#define Tcl_DiscardResult(r) Tcl_DecrRefCount(*(r))
#endif
